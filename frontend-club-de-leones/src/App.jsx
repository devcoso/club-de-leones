...
function App() {
  ...
  >
    ...
    <Panel
      ...
      pt={{
        header:
          'p-5 flex items-center justify-between border border-indigo-300 bg-indigo-500 text-indigo-50 rounded-tl-lg rounded-tr-lg dark:bg- dark:border-indigo-900/40 dark:text-white/80',
      }}
    >
      <p>
