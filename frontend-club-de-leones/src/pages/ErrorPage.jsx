  ...
  if (isRouteErrorResponse(error)) {
    ...
    return (
      <div id="error-page" className=" min-h-screen flex flex-col justify-center items-center gap-5">
        ...
        <h1 className=" text-6xl text-primary text-center">¡Ha ocurrido un Error! {error.status}</h1>
        ...
        <Link className="text-primary text-center underline" to="/">Tal vez quieras volver</Link>
      </div>
    );
    ...
    return (
      <div id="error-page" className=" min-h-screen flex flex-col justify-center items-center gap-5">
        <img src={logo} alt='logo' className='w-5/6 mr-2 my-0 max-w-72'/>
        <h1 className="text-6xl text-primary text-center">Oops! Ha ocurrido un error</h1>
